...
public enum NumberType implements SpinnableType<Number> {
    ...
    INTEGER(
        ...
        (value1st, value2nd) -> Integer.compare(value1st.intValue(), value2nd.intValue()));
    ...
    private final Function<Integer, Number> stepsConvertor;
    ...
    NumberType(Class<? extends Number> valueType,
               ...
               Function<Integer, Number> stepsConvertor,
               Supplier<NumberFormat> format,
               Comparator<Number> comparator) {
        this.valueType = valueType;
        this.adder = adder;
        this.subtractor = subtractor;
        this.stepsConvertor = stepsConvertor;
        this.format = format;
    ...
    @Override public Number steps(int steps) {
        return stepsConvertor.apply(steps);
    }
