...
public class MapPreferencesEntry<T, M extends Map<String, T>> extends StructuredPreferencesEntry<M> {

    public MapPreferencesEntry(Class<?> invoker, String name, Supplier<M> mapSupplier, Function<String, T> transformer, Function<T, String> reverseTransformer) {
        super(
            invoker,
            name,
            structuredValue -> {
