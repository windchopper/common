...
public class DecimalNumeralGeneratorTest {

    void testValue(DecimalNumeralGenerator generator, BigInteger value, String expectedPhrase) {
    ...
    @Test public void testRussian() throws IOException {
        DecimalNumeralGenerator generator = new DecimalNumeralGenerator(Locale.forLanguageTag("ru"));
    ...
    @Test public void testEnglish() throws IOException {
        DecimalNumeralGenerator generator = new DecimalNumeralGenerator(Locale.forLanguageTag("en"));
